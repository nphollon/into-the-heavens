module Flight.Spawn exposing (spawnPlayer, spawnShip, visitorBodyAt, spawnMissile, spawnExplosion, spawnCheckpoint, defaultCockpit, defaultBody, playerId, emptyId, inaction)
